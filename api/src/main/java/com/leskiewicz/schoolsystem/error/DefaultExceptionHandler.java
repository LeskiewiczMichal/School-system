...
public class DefaultExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleArgumentMismatchException(RuntimeException ex, HttpServletRequest request) {
        ApiError apiError = new ApiError(
                request.getRequestURI(),
    ...
    public ResponseEntity<ApiError> handleEntityAlreadyExists(RuntimeException ex, HttpServletRequest request) {
        ApiError apiError = new ApiError(
                request.getRequestURI(),
                ex.getMessage(),
                HttpStatus.BAD_REQUEST.value(),

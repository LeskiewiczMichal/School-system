...
public class UserServiceImpl implements UserService {
    ...
    public void addUser(User user) {
        if (userRepository.findByEmail(user.getEmail()).isPresent()) {
            throw new UserAlreadyExistsException(ErrorMessages.userWithEmailAlreadyExists(user.getEmail()));
        }
        ...
        if (request.getDegreeField() != null || request.getDegreeTitle() != null) {
            ...
            if ((request.getDegreeField() != null && request.getDegreeTitle() == null) || (request.getDegreeField() == null && request.getDegreeTitle() != null)) {
                throw new MissingFieldException(
                        ErrorMessages.objectWasNotUpdated("User") + ". Required fields to update degree: title and field of study");
            }
        ...
        if (request.getEmail() != null) {
            ...
            if (sameEmailUser.isPresent()) {
                throw new UserAlreadyExistsException(
                        ErrorMessages.objectWasNotUpdated("User") + ". " + ErrorMessages.userWithEmailAlreadyExists(request.getEmail()));
            }

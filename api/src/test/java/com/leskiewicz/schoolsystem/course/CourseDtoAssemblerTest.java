  ...
  public void testToModelAddsCorrectLinks() {
    ...
    Link teacherLink =
        WebMvcLinkBuilder.linkTo(methodOn(UserController.class).getUserById(course.getTeacherId()))
            .withRel("teacher");
    Link studentsLink =
        WebMvcLinkBuilder.linkTo(methodOn(CourseController.class).getCourseStudents(1L, null))
            .withRel("students");
    Link filesLink =
        WebMvcLinkBuilder.linkTo(methodOn(CourseController.class).getCourseFiles(1L, null))
            .withRel("files");
